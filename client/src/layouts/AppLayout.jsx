...
export function AppLayout() {
    ...
    <main><Outlet /></main>
    <footer><div className="footer-brand"><span className="footer-dot"></span>dream chaser</div><p>Clear information. Confident futures.</p><div><Link to="/consultancies">Consultancies</Link><Link to="/countries">Explore countries</Link><Link to="/reports/new">Report</Link><Link to="/study/visa">Visa information</Link></div></footer>
  </>;
}
